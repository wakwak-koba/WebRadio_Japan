...
// radiko
  ...
  if(cfg.external_speaker.module_rca)
    radio.setEnableSBR(true);    // If you enable SBR, the sound quality will be better, but it will consume more memory. (PSRAM required)
